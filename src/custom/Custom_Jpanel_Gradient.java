...
public class Custom_Jpanel_Gradient extends JPanel {
    ...
    private Color startColor = Color.MAGENTA;  // Define your gradient start color
    private Color endColor = Color.BLUE;    // Define your gradient end color

    public Custom_Jpanel_Gradient() {
        setOpaque(false);
    }
